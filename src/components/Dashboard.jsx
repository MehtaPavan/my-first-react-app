...
import '../index';
import FilterModal from '../components/FilterModal'; // ✅ Import the modal component
...
const FilterButton = ({ isModalOpen, setIsModalOpen }) => {
  return (
    <div className="flex justify-center items-center">
      ...
      {isModalOpen && <FilterModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />}
    </div>
  );
};
          ...
          <div className="flex flex-col md:flex-row gap-4 items-center">
            <div className="relative flex-grow">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-full md:w-[36rem] border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500"
                value={searchQuery}
            ...
            <button className="bg-white border border-blue-800 text-gray-700 py-2 px-6 rounded-md hover:bg-blue-100 transition duration-300 whitespace-nowrap">
              Reset
            </button>
          </div>
        </div>
